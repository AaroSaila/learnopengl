...
int main() {
    ...
    Shader light_source_shader { "../src/shaders/light_source_shader.vert", "../exercises/ex01/shaders/light_source_shader.frag" };
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        light_source_shader.set_vec3("light_color", light_color);
        glBindVertexArray(light_source_vao);
        glDrawArrays(GL_TRIANGLES, 0, cube_vertices.size());
